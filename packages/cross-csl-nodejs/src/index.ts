...
export class NodeJsWasmModuleProxy {
  private _ctx: string;
    ...
    () => {
        ...
        implements WasmContract.BigNum
      {
        ...
        checkedMul(other: BigNum): Promise<BigNum> {
          return new Promise((resolve, reject) => {
            try {
              ...
              resolve(new BigNum(wasmBigNum, ctxReference));
            } catch (e) {
              reject(e);
            }
          });
        ...
        static fromBytes(bytes: Uint8Array): Promise<BigNum> {
          return new Promise((resolve, reject) => {
            try {
              resolve(new BigNum(WasmV4.BigNum.from_bytes(bytes), ctxReference));
            } catch (e) {
              reject(e);
            }
          });
        ...
        static fromStr(string: string): Promise<BigNum> {
          return new Promise((resolve, reject) => {
            try {
              resolve(new BigNum(WasmV4.BigNum.from_str(string), ctxReference));
            } catch (e) {
              reject(e);
            }
          });
