...
export class WasmModuleProxy implements WasmContract.WasmModuleProxy {
  ...
  public MintBuilder = (() => {
      ...
      implements WasmContract.MintBuilder
    {
      ...
      getRedeeemers(): Promise<WasmContract.Redeemers> {
        return wrapByPromise(() => {
          const ret = this.wasm.get_redeeemers();
  ...
  public NativeScriptSource = (() => {
      ...
      implements WasmContract.NativeScriptSource
    {
      ...
      static newRefInput(scriptHash: WasmContract.ScriptHash, input: WasmContract.TransactionInput, requiredSigners: WasmContract.Ed25519KeyHashes): Promise<WasmContract.NativeScriptSource> {
        return wrapByPromise(() => {
          const ret = WasmV4.NativeScriptSource.new_ref_input(scriptHash.wasm, input.wasm, requiredSigners.wasm);
          return new $outer.NativeScriptSource(ret, $outer._ctx);
        });
      }
  ...
  public PoolVotingThresholds = (() => {
      ...
      implements WasmContract.PoolVotingThresholds
    {
      ...
      static new(motionNoConfidence: WasmContract.UnitInterval, committeeNormal: WasmContract.UnitInterval, committeeNoConfidence: WasmContract.UnitInterval, hardForkInitiation: WasmContract.UnitInterval): Promise<WasmContract.PoolVotingThresholds> {
        return wrapByPromise(() => {
          const ret = WasmV4.PoolVotingThresholds.new(motionNoConfidence.wasm, committeeNormal.wasm, committeeNoConfidence.wasm, hardForkInitiation.wasm);
          return new $outer.PoolVotingThresholds(ret, $outer._ctx);
        });
      }
